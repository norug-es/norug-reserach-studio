...
export function ResearchStudio({ user, projects: initialProjects, initialSnapshot }: Props) {
  ...
  return <div className="shell">
    <aside>
      <div className="brand"><strong>N<span>R</span></strong><b>Research Studio<small>by norug.es · v0.4</small></b></div>
      ...
      <div className="plan"><em>SAAS CORE</em><b>PostgreSQL · Next.js</b><i/><small>Persistencia y API activas</small></div>
