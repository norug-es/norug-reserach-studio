...
import type { ProjectSnapshot, ResearchProject, SessionUser, Workspace } from "@/lib/types";
...
export function ResearchStudio({ user, workspaces, projects: initialProjects, initialSnapshot }: Props) {
  ...
  const [modal, setModal] = useState<"project" | "source" | "evidence" | "workspace" | null>(null);
